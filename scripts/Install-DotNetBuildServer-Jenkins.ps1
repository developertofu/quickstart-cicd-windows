...
try {
    ...
    cmd /c 'java.exe -jar "C:\Program Files (x86)\Jenkins\war\WEB-INF\jenkins-cli.jar" -s http://localhost:8080 groovy --username admin --password $adminpassword = < c:\cfn\scripts\Create-Jenkins-User.groovy'
